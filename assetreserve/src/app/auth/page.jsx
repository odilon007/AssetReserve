...
/* utils */
import { validarEmail, validarCadastro, validarSenhaDetalhada, } from '@/utils/validacao'
...
export default function AuthPage() {
  ...
  // Lógica de "Próximo Requisito" (Um por vez)
      ...
      <div className={styles.wrapper}>
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <button onClick={() => { setIsLogin(!isLogin); setShowPassword(false); }} className={styles.switchBtn}>
